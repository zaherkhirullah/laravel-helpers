...
if (!function_exists('lang_attr')) {
     ...
     * @return string
     */
    function lang_attr($attr, $lang, $prefix = null)
    {
        if (!$prefix) {
            $prefix = '_';
        }
...
if (!function_exists('lang_titles')) {
    function lang_titles()
    {
        return [
            'العربية',
            'الانكليزية',
